    ...
    <>
      <nav>
        ...
        <div className='first'>
          <div className='second'>
            ...
            <a href="/blog" onClick={goBlog}>Blog</a>
            <a href="/about" onClick={goAbout}>About Us</a>
            <a href="/contact" onClick={goContact}>Contact us</a>
          </div>
      ...
      <section className='home-one'>
        ...
        <div className='bottom'>
          {posts.length > 0 && (
  <div className='first'>
    <img src={posts[0].p_img ? getImageUrl(posts[0].p_img) : dom} alt="" />
    <p>By <span>{getAuthorName(posts[0])}</span> | May 23, 2022</p>
    <h2>{posts[0].p_name}</h2>
    <p>{posts[0].p_theme}</p>
    <button onClick={(e) => {
      e.preventDefault();
      navigate(`/post/${posts[0].p_id}`);
    }}>Read More</button>
  </div>
)}
          <div className='second'>
            {posts.slice(0, 4).map((post) => (
              ...
              >
                <p>
                  By <span>{getAuthorName(post)}</span> | {formatDate(post.createdAt)}
                </p>
                <h3 style={{ fontSize: '18px', margin: '5px 0' }}>{post.p_name}</h3>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className='home-three'>
        ...
        <div className='main'>
          <div onClick={goCategory} style={{ cursor: 'pointer' }}>
            <img src={bus} alt="" />
            <h2>Business</h2>
